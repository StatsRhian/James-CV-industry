...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Dr. James}{Edwards}
\mobile{07821 805836} 
%%% Social
\email{jamese1326@gmail.com}
\homepage{james-edwards.netlify.com/}
\github{jedwards24}
%\linkedin{trianglegirl}
%%% Optionals
\position{Statistician {\enskip\cdotp\enskip} Data Scientist {\enskip\cdotp\enskip} Operational Researcher}
